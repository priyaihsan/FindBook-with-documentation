			...
			<div class="container ">
				<div class="row ">
					...
					?>		
									...
									<form method="post" action="../php/update.php">
										...
										<div class="modal-body">
											...
											<div class="mb-3">
												...
												<input type="text" class="form-control" id="nama_buku" value="<?php /** 
									 			* menampilkan nama_buku */ echo $data['nama_buku'] ?>" name="nama_buku" required />
											</div>
											<div class="mb-3">
												<!-- input kategori buku -->
												<label for="kategori_buku" class="form-label">Kategori Buku</label>
												<input type="text" class="form-control" id="kategori_buku" value="<?php /** 
									 			* menampilkan kategori_buku */ echo $data['kategori_buku'] ?>" name="kategori_buku" required />
											</div>
											<div class="mb-3">
												<!-- input penerbit buku -->
												<label for="penerbit_buku" class="form-label">Penerbit Buku</label>
												<input type="text" class="form-control" id="penerbit_buku" value="<?php /** 
									 			* menampilkan penerbit_buku */ echo $data['penerbit_buku'] ?>" name="penerbit_buku" required />
											</div>
											<div class="mb-3">
												<!-- input harga -->
												<label for="harga" class="form-label">Harga</label>
												<input type="text" class="form-control" id="harga" value="<?php /** 
									 			* menampilkan harga */ echo $data['harga'] ?>" name="harga" required />
											</div>
											<div class="mb-3">
												<!-- input diskon -->
												<label for="diskon" class="form-label">Diskon</label>
												<input type="text" class="form-control" id="diskon" value="<?php /** 
									 			* menampilkan diskon */ echo $data['diskon'] ?>" name="diskon" required />
											</div>
											<div class="mb-3">
												<!-- input gambar buku -->
												<label for="gambar_buku" class="form-label">Url Gambar</label>
												<input type="text" class="form-control" id="gambar_buku" value="<?php /** 
									 			* menampilkan gambar_buku */ echo $data['gambar_buku'] ?>" name="gambar_buku" required />
											</div>
											<!-- akhir form control -->
										</div>
						...
						<div class="col-6">
							<img src="<?php /** 
							* menampilkan gambar_buku */ echo $data['gambar_buku'] ?>" alt="" width="400px" class="img-thumbnail shadow p-3 mb-5 bg-body rounded"/>
